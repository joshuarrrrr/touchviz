...
int TouchPoint::id() const { return _id; }

bool TouchPoint::active() const { return _active; }
...
void TouchPoint::set_x(float x) { _x = x; }

void TouchPoint::set_y(float y) { _y = y; }
...
void TouchPoint::finish() { _active = false; }
